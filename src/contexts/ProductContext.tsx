...
const initialProducts: Product[] = [
  ...
  // Alimentaire - Viandes restantes
  {
    id: 4,
    name: "Viande d'agneau fraîche",
    description: "Reste de viande d'agneau de qualité supérieure, parfaite pour grillades ou tajines.",
    price: "2500 DA",
    location: "Blida",
    user: "Boucherie El Baraka",
  ...
  },
  {
    ...
    description: "Poulet fermier élevé en plein air, chair tendre et savoureuse. Idéal pour un repas en famille.",
    price: "1800 DA",
    location: "Tizi Ouzou",
    user: "Ferme Amellal",
  ...
  },
  {
    ...
    description: "Saucisses épicées traditionnelles, préparées avec des épices authentiques algériennes.",
    price: "1500 DA",
    location: "Béjaïa",
    user: "Charcuterie Traditionnelle",
