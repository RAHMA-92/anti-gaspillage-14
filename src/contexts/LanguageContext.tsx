...
const translations = {
  ...
  en: {
    // App
    appTitle: "Anti-Waste DZ",
    appSubtitle: "Reducing waste in Algeria",
    ...
    // Welcome page
    welcome: "Welcome to Anti-Waste DZ",
    welcomeDescription: "Join our community to reduce food waste in Algeria",
    signIn: "Sign In",
    signUp: "Sign Up",
    
    // Sign up
    joinUs: "Join Us!",
    createAccountDescription: "Create your account and start sharing now",
    ...
    // Home page
    heroTitle: "Let's reduce waste together",
    heroDescription: "Give a second life to your products close to their expiry date. Share, exchange and contribute to a more sustainable Algeria.",
    welcomeBack: "Welcome back",
    readyToShare: "Ready to make a difference in your community?",
    getStarted: "Get Started",
    browseProducts: "Browse Products",
    howItWorks: "How it works",
    howItWorksDescription: "Our platform facilitates sharing and waste reduction in three simple steps",
    categoriesDescription: "Explore the different categories of available products",
    realTimeImpact: "Real-time Impact",
    communityImpact: "Here's our community's impact",
    
    // How it works
    step1Title: "1. Share your products",
    step1Description: "Photograph and describe the products you want to share. Add location and important details.",
    step2Title: "2. Find and reserve",
    step2Description: "Browse available products near you and reserve those that interest you.",
    step3Title: "3. Exchange and collect",
    step3Description: "Contact owners to organize collection and create connections in your community.",
    
    // Stats
    sharedProducts: "Shared Products",
    totalAvailableWeight: "Total Available Weight",
    ...
    bakery: "Bakery",
    restaurants: "Restaurants",
    cosmetics: "Cosmetics and parapharmacy products",
    pharmacy: "Pharmaceutical products",
    school: "School supplies",
    tableware: "Tableware",
    clothing: "Clothing",
    rawMaterials: "Raw materials",
    donations: "Items to donate or solidarity donations",
    
    // Add Product
    addProductDescription: "Share your products to avoid waste",
    newProduct: "New Product",
    fillProductInfo: "Fill in your product information",
    productName: "Product Name",
    productNamePlaceholder: "Ex: Artisan bread, Fresh vegetables...",
    category: "Category",
    selectCategory: "Select a category",
    expiryDate: "Expiry Date",
    location: "Location",
    locationPlaceholder: "Ex: Algiers Center, Oran...",
    price: "Price",
    optional: "optional",
    pricePlaceholder: "Ex: Free, 50 DA...",
    description: "Description",
    ...
    // Products page
    discoverProducts: "Discover available products",
    discoverProductsDescription: "Find products near you and help reduce waste",
    ...
    tryModifyingFilters: "Try modifying your search criteria",
    clearFilters: "Clear filters",
    freeDonations: "Free donations available",
    ...
    mySharedProducts: "My Shares",
    myDonations: "My Donations",
    noSharedProducts: "No shared products",
    noDonations: "No donations made",
    shareFirstProduct: "Share your first product to help the community!",
    makeDonation: "Share a free product to help someone!",
    ...
    newProductsDesc: "Receive notifications for new products in your area",
    messagesNotif: "Messages",
    messagesDesc: "Receive notifications for new messages",
    expiryReminders: "Expiration reminders",
    expiryRemindersDesc: "Receive reminders before your products expire",
    privacy: "Privacy",
    privacyDesc: "Control your personal information and its visibility",
    locationSharing: "Location sharing",
    locationSharingDesc: "Allow the app to use your location to improve experience",
    contactPermission: "Contact permission",
    contactPermissionDesc: "Allow other users to contact you via the app",
    ...
    startConversation: "Start a new conversation by contacting a product owner",
    typeMessage: "Type your message...",
    send: "Send",
    you: "You",
    
    // Reserved Products
    reservedProductsTitle: "My Reserved Products",
    reservedProductsDesc: "Track your reservations and organize product collection",
    noReservedProducts: "No reserved products",
    noReservedProductsDesc: "You haven't reserved any products yet. Browse our catalog to discover available products.",
    reserved: "Reserved",
    sharedBy: "Shared by",
    reservedOn: "Reserved on",
    expiryLimit: "Expiry limit",
    
    // Toast messages and errors
    reservedSuccess: "has been reserved successfully",
    productReservedSuccess: "You can now contact the owner to arrange collection",
    ...
    productPublishedSuccess: "Your product has been published successfully",
    errorAddingProduct: "An error occurred while adding the product",
    profileUpdated: "Profile updated",
    profileUpdateSuccess: "Your information has been updated successfully",
    free: "Free",
    loginRequired: "Login required",
    loginRequiredDescription: "You must be logged in to perform this action",
    cannotReserveOwnProduct: "Action impossible",
    cannotReserveOwnProductDescription: "You cannot reserve your own product",
    alreadyReserved: "Already reserved",
    productAlreadyReserved: "This product has already been reserved by someone else",
    cannotContactYourself: "Action impossible",
    cannotContactYourselfDescription: "You cannot contact yourself",
    reservationMessage: "Hello! I'm interested in your product '{productName}'. When can I pick it up?",
    quickActions: "Quick Actions",
    addProductButton: "Add Product",
    addProductDesc: "Share your products with the community",
    myMessagesButton: "My Messages",
    myMessagesDesc: "Communicate with other users",
    ...
    // Quranic Verses on Waste
    islamicWisdom: "Islamic Wisdom",
    quranVerses: "Quranic Verses on Waste",
    verse1: "\"And eat and drink but waste not by excess, for Allah loves not the wasters.\" (Quran 7:31)",
    verse2: "\"And give the relative his right, and the poor and the traveler, and do not spend wastefully.\" (Quran 17:26)",
    verse3: "\"Indeed, the wasteful are brothers of the devils, and ever has Satan been to his Lord ungrateful.\" (Quran 17:27)",
    wasteReflection: "Islam teaches us the importance of avoiding waste and excess. By sharing food and resources, we follow the noble teachings of our religion.",
  }
};
